...
def drop(t):
    ...
    blue_BN_DDS.setfreq(t,BlueMOTBeatnoteScan / 5, units = 'MHz')
...
def time_of_flight(t):
    ...
    blue_BN_DDS.setfreq(t+.0001,BlueMOTBeatnote / 5, units = 'MHz')
...
def grasshopper_fluorescence(t):
    ...
    #current_lock_enable.go_low(t)
    blue_MOT_RF_TTL.go_low(t)
    blue_MOT_RF_TTL.go_high(t+GHExposureTime)
    ...
    GrassHp_XZ.expose(t-0.00005,'fluorescence','atoms', GHExposureTime+.0001)
    return GHExposureTime + 0.002
...
def grasshopper_background(t):
    ...
    blue_MOT_RF_TTL.go_low(t)
    blue_MOT_RF_TTL.go_high(t+GHExposureTime)
    GrassHp_XZ.expose(t-0.00005,'fluorescence','background', GHExposureTime+.0001)
