...
#print('    Data saved.')
#print('Done') 
imageType = 'absorption'
run.save_result(imageType + '/x_position', 0)
run.save_result(imageType + '/y_position', -.5*9.8*tof**2)
run.save_result(imageType + '/x_width', np.sqrt(.0002**2+(1.38*10**-23*.001/(88/(6.022*10**26)))*tof**2))
run.save_result(imageType + '/y_width', np.sqrt(.0001**2+(1.38*10**-23*.001/(88/(6.022*10**26)))*tof**2))