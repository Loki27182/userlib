...
variable_info = {'BlueMOTShimX': {'plot_title': 'Varying X-axis Shim Current','axis_label': 'X trim current (A)','scale': 1.0, 'prefer_x': 1},
                 ...
                 'DummyVariable': {'plot_title': '707 Power','axis_label': '707 power (mW)','scale': 1.0, 'prefer_x': 0},
                 'SidebandBlowawayDuration': {'plot_title': 'Varying Blowaway Pulse Duration','axis_label': 'Blowaway Pulse Duration ($\mu$s)','scale': 1.0e6, 'prefer_x': 0},
                 'SidebandPulseDuration': {'plot_title': 'Varying Sideband Pulse Duration','axis_label': 'Sideband Pulse Duration ($\mu$s)','scale': 1.0e6, 'prefer_x': 0},
                 'SidebandHeatingDuration': {'plot_title': 'Sideband cooling pulse duration','axis_label': 'Sideband cooling pulse duration (ms)','scale': 1.0e3, 'prefer_x': 0},
                 'SidebandHeatingFrequency': {'plot_title': 'Sideband heating pulse frequency','axis_label': 'Sideband heating pulse frequency (MHz)','scale': 1.0, 'prefer_x': 1},
                 'SidebandFrequency': {'plot_title': 'Sideband pulse frequency','axis_label': 'Spectroscopy pulse frequency (MHz)','scale': 1.0, 'prefer_x': 1},
...
result_info = {'atomNumber': {'axis_label': 'Atom number (millions)','scale': 1.0e-6,'plot_flag':True},
                 'x_position': {'axis_label': 'X-position ($\mu$m)','scale': 1.0e6,'plot_flag':True},
